...
#define Z_STEP_PIN               DIO7
#define Z_DIR_PIN                DIO8
//#define Z_MIN_PIN                DIO12
//#define Z_MAX_PIN                DIO12
//#define Z_ENABLE_PIN             AIO0
#define Z_INVERT_DIR
#define Z_INVERT_MIN
#define Z_INVERT_MAX
#define Z_INVERT_ENABLE

#define E_STEP_PIN               DIO9
#define E_DIR_PIN                DIO10
//#define E_ENABLE_PIN             AIO1
#define E_INVERT_DIR
...
#define STEPPER_ENABLE_PIN       AIO0
...
DEFINE_TEMP_SENSOR(bed,      TT_THERMISTOR, AIO7,  THERMISTOR_BED)

// Beta algorithm      r0      beta  r2    vadc
// Steinhart-Hart      rp      t0    r0      t1    r1      t2    r2
//TEMP_TABLE EXTRUDER (100000, 3950, 4700, 5.0)
//TEMP_TABLE BED      (21000,  3950, 4700, 5.0)
